            ...
            <div className="h-5/6 w-full flex flex-col justify-between items-center p-0 m-0 shadow-md rounded-lg border border-gray-200 gap-2">
                ...
                <section className='w-full flex flex-col justify-between items-center gap-2 mt-3'>
                    <table className='w-10/12'>
                        <thead>
                            <tr>
                                <th className='uppercase font-bold bg-slate-600 p-1 px-3 text-start text-slate-100'>Prodcuto</th>
                        ...
                        <tbody>
                            {
                                false ? (
                                    ...
                                    <tr className='bg-gray-200 text-center'>
                                        <td className='text-center' colSpan={6}>X No hay productos en el carrito</td>
                                    </tr>
                                )
                            }
                        </tbody>
