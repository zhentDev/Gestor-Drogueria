...
function InformacionInventario() {
      ...
      <div className="w-2/5 h-fit m-5 p-3 border-2 border-rose-950 rounded-lg flex justify-center flex-wrap">
        ...
        <div className="text-center">
          ...
          <div className="my-3">
            ...
            <button
              className="mx-1 p-2 bg-slate-300 border-indigo-800 rounded-xl px-4 py-1 text-center h-auto w-auto align-middle shadow-md shadow-emerald-600 border-opacity-60 border-2 hover:border-opacity-0 hover:brightness-90 font-semibold my-2"
...
export default InformacionInventario;
